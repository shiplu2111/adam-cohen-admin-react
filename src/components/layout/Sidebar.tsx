...
const NAV: { section: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Contact Inquiries", icon: MessageSquare, to: "/contacts", permission: "read contacts" },
      { label: "Business Inquiries", icon: Briefcase, to: "/business-inquiries", permission: "read content" },
    ],
  },
  {
    section: "Engagement",
